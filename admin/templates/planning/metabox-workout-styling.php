<p>
  ...
  <label for="fitplan_planning_workout_display_pic"><?php _e('Show workout logo', 'fitness-schedule'); ?></label>
</p>
...
<p>
  ...
  <label for="fitplan_planning_workout_display_title"><?php _e('Show workout name', 'fitness-schedule'); ?></label>
</p>
...
<p>
  ...
  <label for="fitplan_planning_workout_display_color"><?php _e('Show workout background color', 'fitness-schedule'); ?></label>
</p>
...
<div class="fitplan-default-bg-color" style="<?php if($this->datas['fitplan_planning_workout_display_color'] == "on"): echo 'display: none'; endif; ?>">
  <label class="fitplan-label" for="fitplan_planning_workout_default_color"><?php _e('All items background color', 'fitness-schedule'); ?></label>
...
<label class="fitplan-label" for="fitplan_planning_workout_text_color"><?php _e('Text color', 'fitness-schedule'); ?></label>
...
<label class="fitplan-label" for="fitplan_planning_workout_radius"><?php _e('Border radius', 'fitness-schedule'); ?></label>
