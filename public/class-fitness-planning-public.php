 ...
 * @subpackage Fitness_Planning/public
 */
...
class Fitness_Planning_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Fitness_Planning_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Fitness_Planning_Loader will then create the relationship
